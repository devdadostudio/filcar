...
<section id="<?php echo esc_attr($block_id); ?>" class="hero-video-normal-slider">
    <div class="hero-video-normal-slider__stage">
        <?php if ($video_url) : ?>
            <video class="hero-video-normal-slider__video" src="<?php echo esc_url($video_url); ?>" <?php echo $poster_url ? 'poster="' . esc_url($poster_url) . '"' : ''; ?> autoplay muted loop playsinline preload="auto"></video>
        <?php endif; ?>

        <div class="hero-video-normal-slider__shade" aria-hidden="true"></div>

        <?php
        get_template_part('parts/breadcrumbs', null, [
            'variant' => 'dark',
            'layout' => 'overlay',
            'class' => 'hero-video-normal-slider__breadcrumb',
            'col_class' => 'col-12',
        ]);
        ?>

        <div class="container-fluid hero-video-normal-slider__content">
            <div class="row w-100">
                <div class="col-12 col-lg-9 col-xl-8 col-uxl-7">
                    <div class="hero-video-normal-slider__copy">
                        ...
                        <?php if ($text) : ?>
                            <div class="hero-video-normal-slider__text h7 fw-normal">
                                <?php echo wp_kses_post($text); ?>
                            </div>
                        <?php endif; ?>

                        <?php if ($cta_url) : ?>
                            <a class="hero-video-normal-slider__cta p-small" href="<?php echo esc_url($cta_url); ?>" target="<?php echo esc_attr($cta_target); ?>">
