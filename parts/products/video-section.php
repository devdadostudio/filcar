        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 col-12 sp-mt-5">
                <figure class="respimg sp-mb-0 aspect-ratio-16x7 rounded-3 overflow-hidden position-relative">
                    <video>
                        <source src="<?php echo get_template_directory_uri(); ?>/img/mov_bbb.mp4" type="video/mp4">
                ...
                <div class="sp-mb-0 sp-mt-1 sp-md-mt-3 h5 fw-light text-white">Next-Gen Exhaust Control</div>
            </div>
        </div>
    </div>
</section>
