...
<section id="contactForm" class="contact-form-block position-relative overflow-hidden sp-pt-6 sp-pb-0 sp-md-pt-13 sp-llg-pt-13 <?php if(isset($args['footer-color'])){ echo $args['footer-color'];}else{ echo !is_page_template('page-download.php') ? 'bg-grey' : 'bg-primary'; } ?>">
