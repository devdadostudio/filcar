    ...
    if (function_exists('acf_add_local_field_group')) {
        ...
        acf_add_local_field_group([
            ...
            'fields' => [
                ...
                [
                    'key' => 'field_progettazione_png_sequence_nav_sequence_layout',
                    'label' => __('Variante sequenza', 'filcar'),
                    'name' => 'sequence_layout',
                    'type' => 'select',
                    'choices' => [
                        'standard' => __('Immagine singola con testi verticali', 'filcar'),
                        'pinned_composition' => __('Composizione pinnata', 'filcar'),
                    ],
                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'field_progettazione_png_sequence_nav_sequence_point_image',
                            'label' => __('Immagine punto', 'filcar'),
                            'name' => 'image',
                            'type' => 'image',
                            'return_format' => 'array',
                            'preview_size' => 'medium',
                ...
                [
                    'key' => 'field_progettazione_png_sequence_nav_compositions_title',
                    'label' => __('Titolo composizioni', 'filcar'),
                    'name' => 'compositions_title',
                    'type' => 'text',
                ],
                [
                    'key' => 'field_progettazione_png_sequence_nav_compositions_text',
                    'label' => __('Testo composizioni', 'filcar'),
                    'name' => 'compositions_text',
                    'type' => 'textarea',
                    'rows' => 5,
                    'new_lines' => 'br',
                ],
