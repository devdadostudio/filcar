            ...
            'fields' => [
                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'field_progettazione_png_sequence_nav_sequence_point_progress',
                            'label' => __('Progress sequenza', 'filcar'),
                            'name' => 'sequence_progress',
                            'type' => 'number',
                            'instructions' => __('Percentuale della sequenza in cui questo punto diventa attivo. Struttura 0, Modularità 50, Verticalità 100.', 'filcar'),
                            'min' => 0,
                            'max' => 100,
                            'step' => 1,
                            'append' => '%',
